...
$(document).ready(function(){
	...
	$.jqGrid($('#grid'), {
		url:contextRoot + "/sheet/cashtotalall/list.json",
		datatype: "json",
		autowidth: true,
		postData: {
...
function insertAction(obj) {
	...
	var url = contextRoot + "/sheet/cashtotalall/insert.json";
...
function updateAction(obj) {
	var url = contextRoot + "/sheet/cashtotalall/update.json";
	var params = "memberId=" + encodeURIComponent($("#iMemberId").val().trim());
		params += "&memberNo=" + encodeURIComponent($("#iMemberNo").val().trim());
		params += "&memberName=" + encodeURIComponent($("#iMemberName").val().trim());
		params += "&sexType=" + encodeURIComponent($("#iSexType").val());
...
function deleteAction(obj) {
	var url = contextRoot + "/sheet/cashtotalall/delete.json";
...
function deleteMultiAction(obj) {
	...
	var url = contextRoot + "/sheet/cashtotalall/deleteMulti.json";
	var params = "";
