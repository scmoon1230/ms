...
$(document).ready(function(){
	...
	$.jqGrid($('#grid'), {
		url:contextRoot + "/sheet/summonth/list.json",
		datatype: "json",
		autowidth: true,
		postData: {
		...
		sortname: 'AC.ACCT_GB, AC.ACCT_CODE',
		sortorder: 'ASC',
		viewrecords: true,
		multiselect: false,
		loadonce:false,
		...
		loadComplete : function (data) {
			...
			var params = "stanYm=" + $("#stanYm").val().replaceAll("-", "");
				params += "&stanYmd=" + $("#stanYm").val().replaceAll("-", "")+'01';
				params += "&acctGb=" + $("#acctGb").val();
				
			$.ajaxEx($('#grid'), {
				url : contextRoot + "/sheet/summonth/getSum.json",
				datatype: "json",
				data: params,
