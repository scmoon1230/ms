...
$(document).ready(function(){
	...
	$.jqGrid($('#grid'), {
		url:contextRoot + "/sheet2/summonth/list.json",
		datatype: "json",
		autowidth: true,
		postData: {
			stanYm         : $("#stanYm").val().replaceAll("-", "")
		...
		sortname: 'MAS.ACCT_GB, MAS.ACCT_CODE',
		sortorder: 'ASC',
		viewrecords: true,
		multiselect: false,
		loadonce:false,
		...
		loadComplete : function (data) {
			...
			var params = "stanYm=" + $("#stanYm").val().replaceAll("-", "");
				params += "&acctGb=" + $("#acctGb").val();
				
			$.ajaxEx($('#grid'), {
				url : contextRoot + "/sheet2/summonth/getSum.json",
				datatype: "json",
				data: params,
	...
	$(".btnS").bind("click",function(){
		...
		//검색할 조건의 값을 설정한다.
		myPostData.stanYm  = $("#stanYm").val().replaceAll("-", "");
...
function insertAction(obj) {
	...
	var url = contextRoot + "/sheet2/summonth/insert.json";
...
function updateAction(obj) {
	var url = contextRoot + "/sheet2/summonth/update.json";
	var params = "memberId=" + encodeURIComponent($("#iMemberId").val().trim());
		params += "&memberNo=" + encodeURIComponent($("#iMemberNo").val().trim());
		params += "&memberName=" + encodeURIComponent($("#iMemberName").val().trim());
		params += "&sexType=" + encodeURIComponent($("#iSexType").val());
...
function deleteAction(obj) {
	var url = contextRoot + "/sheet2/summonth/delete.json";
...
function deleteMultiAction(obj) {
	...
	var url = contextRoot + "/sheet2/summonth/deleteMulti.json";
	var params = "";
