...
<script>
	...
	var sortOr = '';
	if ( '1' == '${type}' ) {
		sortBy = 'ACCT_GB, SEQ_NO';
		sortOr = 'DESC';
	}
</script>
<script src="<c:url value='/js/sheet/sheetmng.js'/>"></script>
</head>
<body>
				...
				<div class="layerCt">
					<div class="tableType2">
						<table>
							...
							<tbody>
								<tr><th>전표번호</th>	<td colspan="3" id="dSeqNo"></td>
								</tr>
								<tr><th>계정과목</th>	<td colspan="3" id="dAcctInfo"></td>
								</tr>
								<tr><th>금액</th>		<td colspan="3" id="dMoneyAmt"></td>
								</tr>
								<tr><th>내역</th>		<td colspan="3" id="dAcctRemark"></td>
								</tr>
							</tbody>
						</table>
					</div>
