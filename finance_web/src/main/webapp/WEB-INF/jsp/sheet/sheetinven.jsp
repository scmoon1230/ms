...
<script>
	var sortBy = 'ACCT_GB, UP_MONEY_AMT DESC, MONEY_AMT';
	var sortOr = 'DESC';
</script>
<script src="<c:url value='/js/sheet/sheetinven.js'/>"></script>
</head>
<body>
...
<div id="wrapper" class="wth100">
	...
	<div class="container">
		...
		<div class="contentWrap">
			<div class="content">
				<ol class="breadcrumb">
					<li class="active">입출관리 > 입출보고 > 수입/지출 명세표</li>
				</ol>
					...
					<table>
						...
						<tr>
							...
							<td><select name="" id="inoutGb" class="selectType1" maxlength="1" onchange="$('.btnS').click()">
								<!--<option value="">전체</option>
									<option value="수입" selected=true>수입</option>-->
