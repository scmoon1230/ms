...
<script src="<c:url value='/js/fin/finmast.js'/>"></script>
</head>
<body>
...
<div id="wrapper" class="wth100">
	...
	<div class="container">
		...
		<div class="contentWrap">
			<div class="content">
				<ol class="breadcrumb">
					<li class="active">입출관리 > 금융자산관리 > 금융자산명세</li>
				</ol>
				<div class="tableTypeHalf seachT">
					<table>
						<caption>금융자산명세</caption>
						<colgroup>
						...
						<tr>
							...
							<td><select name="" id="acctGb" class="selectType1" maxlength="1" onchange="$('.btnS').click()">
									...
									<c:forEach items="${acctgbList}" var="val">
										<option value="${val.acctGb}">${val.acctGb} - <c:out value="${val.acctGbName}" ></c:out></option>
									</c:forEach>
								</select>
							</td>
							<th>자산</th>
