...
<script src="<c:url value='/js/fin/finweek.js'/>"></script>
</head>
<body>
...
<div id="wrapper" class="wth100">
	...
	<div class="container">
		...
		<div class="contentWrap">
			<div class="content">
				<ol class="breadcrumb">
					<li class="active">입출관리 > 금융자산관리 > 재정별 금융자산 현황</li>
				</ol>
				...
				<div class="tit">
					<h4 style="text-align:right; padding-right: 20px;">
						전월잔액 : <span id="prevTotalAmt"></span> 원 &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
						증가 : <span id="plusTotalAmt"></span> 원 &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
						감소 : <span id="minusTotalAmt"></span> 원 &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
						금월잔액 : <span id="lastTotalAmt"></span> 원
					 </h4>
				</div>
