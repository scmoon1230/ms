...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$.jqGrid($('#grid'),
		{
			  url : "<c:url value='/wrks/evtctl/stats/cctvMonUsers/list.json'/>"
			, datatype: "json"
			, autowidth: true
			, postData :
			{
			...
			[
				  ...
				  { name: 'USER_NM', width:140, cellattr:function(){ return 'style="width: 140px;"'}, align:'center', sortable: false}
			...
			, loadComplete : function (data)
			{
				...
				// 합계급액 셋팅
				$('#grid').jqGrid("footerData", "set", {USER_NM: "합  계", M_01 : sum01});
				$('#grid').jqGrid("footerData", "set", {USER_NM: "합  계", M_02 : sum02});
				$('#grid').jqGrid("footerData", "set", {USER_NM: "합  계", M_03 : sum03});
				$('#grid').jqGrid("footerData", "set", {USER_NM: "합  계", M_04 : sum04});
				$('#grid').jqGrid("footerData", "set", {USER_NM: "합  계", M_05 : sum05});
				$('#grid').jqGrid("footerData", "set", {USER_NM: "합  계", M_06 : sum06});
				$('#grid').jqGrid("footerData", "set", {USER_NM: "합  계", M_07 : sum07});
				$('#grid').jqGrid("footerData", "set", {USER_NM: "합  계", M_08 : sum08});
				$('#grid').jqGrid("footerData", "set", {USER_NM: "합  계", M_09 : sum09});
				$('#grid').jqGrid("footerData", "set", {USER_NM: "합  계", M_10 : sum10});
				$('#grid').jqGrid("footerData", "set", {USER_NM: "합  계", M_11 : sum11});
				$('#grid').jqGrid("footerData", "set", {USER_NM: "합  계", M_12 : sum12});
	...
	function excelDownAction()
	{
		...
		document.excelDownFrm.action = "<c:url value='/wrks/evtctl/stats/cctvMonUsers/list.excel'/>";
    ...
    <div class="container">
      ...
      <%//@include file="/WEB-INF/jsp/cmm/leftMenu.jsp"%>
		...
		<div class="contentWrap">
			...
			<div class="content">
				<div class="titArea">
					<!-- <h3 class="tit">CCTV접속현황(월/사용자)</h3> -->
					<h3 class="tit"><%=menu_nm%></h3>
				</div>
				<div class="tableType2 seachT">
					<table>
					<caption>CCTV접속현황(월/사용자)</caption>
					<colgroup>
