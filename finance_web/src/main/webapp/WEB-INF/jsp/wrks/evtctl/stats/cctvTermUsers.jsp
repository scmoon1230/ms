...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$.jqGrid($('#grid'),
		{
			  url : "<c:url value='/wrks/evtctl/stats/cctvTermUser/list.json'/>"
			, datatype: "json"
			, autowidth: true
			, postData :
			{
			...
			, colModel :
			[
				  { name: 'USER_NM', width:160, cellattr:function(){ return 'style="width: 160px;"'}, align:'center'}
			...
			, loadComplete : function (data)
			{
				...
				// 합계급액 셋팅
				$('#grid').jqGrid("footerData", "set", {USER_NM: "합  계", TOT_EVT_CNT : sum01});
				$('#grid').jqGrid("footerData", "set", {USER_NM: "합  계", CONN_EVT_CNT : sum02});
				$('#grid').jqGrid("footerData", "set", {USER_NM: "합  계", CCTV_CONN_CNT : sum03});
				$('#grid').jqGrid("footerData", "set", {USER_NM: "합  계", PTZ_CONN_CNT : sum04});
	...
	function excelDownAction()
	{
		...
		document.excelDownFrm.action = "<c:url value='/wrks/evtctl/stats/cctvTermUser/list.excel'/>";
    ...
    <div class="container">
      ...
      <%//@include file="/WEB-INF/jsp/cmm/leftMenu.jsp"%>
		...
		<div class="contentWrap">
			...
			<div class="content">
				<div class="titArea">
					<!-- <h3 class="tit">CCTV접속현황(기간/사용자</h3> -->
					<h3 class="tit"><%=menu_nm%></h3>
				</div>
				<div class="tableType2 seachT">
					<table>
					<caption>CCTV접속현황(기간/사용자)</caption>
					<colgroup>
