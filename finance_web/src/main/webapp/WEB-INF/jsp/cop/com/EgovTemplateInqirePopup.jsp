...
<script type="text/javascript">
    ...
    function fn_egov_select_tmplatInfo(pageNo){
        ...
        document.frm.action = "<c:url value='/wrks/cop/com/selectTemplateInfsPop.do'/>";
        document.frm.submit();  
    }
...
<body>
<form name="frm" action ="<c:url value='/wrks/cop/com/selectTemplateInfsPop.do'/>" method="post">
                ...
                <ul id="search_second_ul">
                    <li>
                        <div class="buttons" style="position:absolute;left:700px;top:47px;">
                            <a href="<c:url value='/wrks/cop/com/selectTemplateInfsPop.do'/>" onclick="fn_egov_select_tmplatInfo('1'); return false;" ><img src="<c:url value='/images/img_search.gif'/>" alt="search" />조회 </a>
                        </div>                              
                    </li>
                </ul>           
            </div>          
               ...
               <td nowrap="nowrap">
                   <c:if test="${result.useAt == 'Y'}">
                       <input type="button" name="selectTmplat" value="선택" 
                           onclick="fn_egov_returnTmplatInfo('<c:out value="${result.tmplatId}"/>','<c:out value="${result.tmplatNm}"/>')" />
                   </c:if>         
               </td>  
             </tr>
        </c:forEach>     
    ...
    <div class="buttons" align="center" >
        <table border="0" cellspacing="0" cellpadding="0" align="center">
            <tr> 
                <td><a href="#LINK" onclick="parent.close();">닫기</a></td>
            </tr>
        </table>    
    </div>
</form>
