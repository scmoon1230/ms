...
<script type="text/javascript">
    function fn_egov_update_tmplatInfo() {
        if (confirm('<spring:message code="common.update.msg" />')) {
            document.templateInf.action = "<c:url value='/wrks/cop/com/updateTemplateInf.do'/>";
...
<div id="wrapper">
	...
	<div class="container">
		...
		<div class="contentWrap">
			...
			<!-- content Start -->
			<div class="content">
				<div class="titArea"><h3 class="tit">템플릿 정보수정</h3></div>
				<!-- table add start -->
                          ...
                          <tr> 
                            ...
                            <select id="tmplatSeCode" name="tmplatSeCode" class="select" onchange="fn_egov_selectTmplatType(this)">
                                ...
                                <c:forEach var="result" items="${resultList}" varStatus="status">
                                    <option value='<c:out value="${result.CD_ID}"/>' <c:if test="${TemplateInfVO.tmplatSeCode == result.CD_ID}">selected="selected"</c:if> ><c:out value="${result.CD_NM_KO}"/></option>
                                </c:forEach>    
				...
				<div class="btnWrap btnR">
					<a href="#" onclick="fn_egov_update_tmplatInfo();" class="btn btnDt btnRgt">저장</a>
