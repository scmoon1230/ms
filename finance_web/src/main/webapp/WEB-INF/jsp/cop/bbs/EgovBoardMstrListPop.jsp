...
<script type="text/javascript">
    ...
    function fn_egov_select_brdMstr(pageNo){
        ...
        document.frm.action = "<c:url value='/wrks/cop/bbs/SelectBBSMasterInfsPop.do'/>";
        document.frm.submit();                  
    }
...
<body>
<form name="frm" method="post" action="<c:url value='/wrks/cop/bbs/SelectBBSMasterInfsPop.do'/>">
                ...
                <ul id="search_second_ul">
                    <li>
                        <div class="buttons" style="float:right;">
                            <a href="<c:url value='/wrks/cop/bbs/SelectBBSMasterInfsPop.do'/>" onclick="fn_egov_select_brdMstr('1'); return false;"><img src="<c:url value='/images/img_search.gif'/>" alt="search" />조회 </a>
                        </div>                              
                    </li>
                </ul>           
            </div>          
             ...
             <tr>
                ...
                <td nowrap="nowrap">
                    <input type="button" value="선택"  
                        onclick="fn_egov_select_brdMstrInfo('<c:out value="${result.bbsId}"/>','<c:out value="${result.bbsNm}"/>');" />
                </td>
              </tr>
         </c:forEach>     
