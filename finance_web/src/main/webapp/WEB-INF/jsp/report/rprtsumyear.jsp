...
<script src="<c:url value='/js/report/rprtsumyear.js'/>"></script>
</head>
<body>
...
<div id="wrapper" class="wth100">
	...
	<div class="container">
		...
		<div class="contentWrap">
			<div class="content">
				<ol class="breadcrumb">
					<li class="active">헌금관리 > 헌금보고 > 연간 헌금현황</li>
				</ol>
				...
				<div class="tit">
					<h4 style="text-align:right; padding-right: 20px;">
						12월 : <span id="monthAmnt0"></span> 원 &nbsp; &nbsp;
						1월 : <span id="monthAmnt1"></span> 원 &nbsp; &nbsp;
						2월 : <span id="monthAmnt2"></span> 원 &nbsp; &nbsp;
						3월 : <span id="monthAmnt3"></span> 원 &nbsp; &nbsp;
						4월 : <span id="monthAmnt4"></span> 원 &nbsp; &nbsp;
						5월 : <span id="monthAmnt5"></span> 원 &nbsp; &nbsp;
						6월 : <span id="monthAmnt6"></span> 원 &nbsp; &nbsp;
						7월 : <span id="monthAmnt7"></span> 원 &nbsp; &nbsp;
						8월 : <span id="monthAmnt8"></span> 원 &nbsp; &nbsp;
						9월 : <span id="monthAmnt9"></span> 원 &nbsp; &nbsp;
						10월 : <span id="monthAmnt10"></span> 원 &nbsp; &nbsp;
						11월 : <span id="monthAmnt11"></span> 원 &nbsp; &nbsp;
