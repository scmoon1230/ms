...
<script src="<c:url value='/js/sheet2/sheet2summonth.js'/>"></script>
</head>
<body>
...
<div id="wrapper" class="wth100">
	...
	<div class="container">
		...
		<div class="contentWrap">
			<div class="content">
				<ol class="breadcrumb">
					<li class="active">입출관리 > 마감원장(종교인과세) > 월마감원장(종교인과세)</li>
				</ol>
				<div class="tableTypeHalf seachT">
					<table>
						...
						<tr>
                            <th>기준월</th>
							<td><input type="month" id="stanYm" class="date8Type" value="${currentMonth}"
				...
				<div class="tit">
					<h4 style="text-align:right; padding-right: 20px;">
						수입합계 : <span id="inTotalAmnt"></span> 원 &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
						지출합계 : <span id="outTotalAmnt"></span> 원
					 </h4>
				</div>
