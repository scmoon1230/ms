...
<div class="panel panel-danger" id="out-rqst-aprv">
	<div class="panel-heading">
		...
		<h3 class="panel-title">입수/반출 선택승인</h3>
	</div>
	...
	<div class="panel-footer">
		<div class="row">
			<div class="col-xs-12 text-center">
				<button type="button" class="btn btn-primary btn-xs" title="확인" onclick="oOutFirstAprv.out.aprvMulti.approve();">확인</button>
				<button type="button" class="btn btn-secondary btn-xs" title="취소" onclick="oOutFirstAprv.out.aprvMulti.close();">취소</button>
			</div>
		</div>
	</div>
</div>
