	...
	<div class="panel-footer">
		<div class="row">
			<div class="col-xs-12 text-center">
				<button type="button" class="btn btn-primary btn-xs" title="등록" onclick="oOutExtnAprv.out.checkHash.register();">등록</button>
				<button type="button" class="btn btn-secondary btn-xs" title="취소" onclick="oOutExtnAprv.out.checkHash.close();">취소</button>
			</div>
		</div>
	</div>
</div>