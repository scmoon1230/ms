...
<%--<link type="text/css" rel="stylesheet" href="<c:url value='/js/ol5/ol-ext.css'/>">--%>
...
<article id="container-map">
    ...
    <nav class="navbar navbar-default" id="ol-map-menu" style="margin-bottom: 0px;">
        <div class="container-fluid">
            <!-- 기본도 -->
            <c:if test="${cmConfig.gisAerialYn ne 'N'}">
            ...
            <div class="navbar-form navbar-left" id="ol-map-menu-search" role="search" style="padding-left: 5px;">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control input-sm" id="ol-map-menu-search-keyword" size="20" maxlength="255" placeholder="검색할 키워드를 입력하세요.">
                </div>
            ...
            <!-- 기본화면 위치로 이동 -->
            <div class="navbar-form navbar-left" id="ol-map-menu-center" role="move" style="padding-left: 5px;">
                <button type="button" class="btn btn-default btn-sm" data-toggle="tooltip" title="기본화면 위치로 이동" onclick="olMap.setCenter([oConfigure.pointX, oConfigure.pointY]);">
                    <i class="fas fa-map-marker-alt fa-lg"></i>
                </button>
                <button type="button" class="btn btn-default btn-sm" data-toggle="tooltip" title="지도이미지 다운로드" onclick="olSwipMap.util.export();">
                    <i class="fas fa-download fa-lg"></i>
                </button>
                <a id="ol-map-image-download" download="map.png"></a>
            </div>

            <!-- 측정 -->
            <div class="navbar-form navbar-left" id="ol-map-menu-measure" role="measure" style="padding-left: 5px;">
                <button type="button" class="btn btn-default btn-sm" data-toggle="tooltip" title="측정: 해제" onclick="olSwipMap.measure.clear();">
                    <i class="fas fa-sync-alt fa-lg"></i>
                </button>
                <button type="button" class="btn btn-default btn-sm" data-toggle="tooltip" title="측정: 거리" onclick="olSwipMap.measure.init('LineString');">
                    <i class="fas fa-ruler-horizontal fa-lg"></i>
                </button>
                <button type="button" class="btn btn-default btn-sm" data-toggle="tooltip" title="측정: 면적" onclick="olSwipMap.measure.init('Polygon');">
            ...
            <div class="navbar-form navbar-right ol-map-menu-bookmark">
                <div class="form-group">
                    <div class="dropdown ol-map-menu-tools" data-toggle="tooltip" title="즐겨찾기로 지정해둔 지점으로 이동">
                        <button class="btn btn-default btn-sm dropdown-toggle" type="button" id="ol-map-menu-bookmark" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                            즐겨찾기
    ...
    <div id="map-index-container">
        ...
        <button type="button" id="btn-ol-map-index-collapse" title="접기/펴기" onclick="olSwipMap.indexmap.collapse(this);">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <table class="table table-striped table-condensed" id="table-pointermove-fclt">
                        <%--
                        <caption>
                            <span> <i class="fas fa-sync-alt"></i> : 회전형 CCTV </span>
                        </caption>
                        --%>
                        <thead>
                        <tr>
                            <th scope="col" id="th-pointermove-fclt">시설물명</th>
                            <th scope="col">유형(용도)</th>
                            <th scope="col">상태</th>
                            <th scope="col" id="th-pointermove-ext"></th>
                        </tr>
                        </thead>
                        <tbody></tbody>
                    </table>
                ...
                <%--
                <div class="col-xs-12">
                    <table class="table table-striped table-condensed" id="table-pointermove-event">
                        <caption>
                            <span class="label label-warning">이벤트</span>
                        </caption>
                        <thead>
                        <tr>
                            <th scope="col">이벤트명</th>
                            <th scope="col">세부분류</th>
                ...
                --%>
                <div class="col-xs-12" id="container-pointermove-extra">
                    <table class="table table-striped table-condensed" id="table-pointermove-extra">
                        <caption>
                            <span class="label" id="caption-pointermove-extra"></span>
                        </caption>
                        <thead id="thead-pointermove-extra"></thead>
                        <tbody id="tbody-pointermove-extra"></tbody>
                    </table>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-xs-12">
                    <table class="table table-striped table-condensed" id="table-click-fclt">
                        ...
                        <thead>
                        <tr id="tr-click-fclt">
                            <th scope="col" id="th-click-fclt">시설물명</th>
                            <th scope="col">유형(용도)</th>
                            <th scope="col">상태</th>
                            <th scope="col" id="th-click-ext"></th>
                        </tr>
                        </thead>
                        <tbody></tbody>
                    </table>
                ...
                <%--
                <div class="col-xs-12">
                    <table class="table table-striped table-condensed" id="table-click-event">
                        <caption>
                            <span class="label label-warning">이벤트</span>
                        </caption>
                        <thead>
                        <tr id="tr-click-event">
                            <th scope="col">이벤트명</th>
                            <th scope="col">세부분류</th>
                            <th scope="col">발생시각</th>
                            <th scope="col"></th>
                ...
                --%>
                <div class="col-xs-12" id="container-click-extra">
                    <table class="table table-striped table-condensed" id="table-click-extra">
                        <caption>
                            <span class="label" id="caption-click-extra"></span>
                        </caption>
                        <thead id="thead-click-extra"></thead>
                        <tbody id="tbody-click-extra"></tbody>
                    </table>
                </div>
            </div>
        </div>
    ...
    <!-- 오버레이 : 공용 -->
    <div id="ol-overlay-popover-extra" class="label label-primary" style="display:none;"></div>
</article>
<script src="<c:url value='/js/ol5/ol.js'/>"></script>
<script src="<c:url value='/js/ol5/proj4.js'/>"></script>
<!-- ol-ext.js -->
<script src="<c:url value='/js/ol5/ol-ext.js'/>"></script>
<script src="<c:url value='/js/ol5/extra/FontAwesome5Def.js'/>"></script>
