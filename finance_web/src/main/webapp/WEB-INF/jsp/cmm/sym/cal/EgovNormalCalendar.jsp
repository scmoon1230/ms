	 		...
	 		<c:forEach var="result" items="${resultList}" varStatus="status">
				...
				<c:otherwise>
			 		...
			 		<c:when test='${result.restAt == "Y" }'>
					    <td class="lt_text3"  STYLE="color:red;cursor:pointer;cursor:hand" onclick="fnReturnDay(${result.day});">
					    	${result.day}
					    </td>
					</c:when>
					<c:otherwise>
					    <td class="lt_text3"  STYLE="color:black;cursor:pointer;cursor:hand" onclick="fnReturnDay(${result.day});">
					    	${result.day}
					    </td>
					</c:otherwise>
					</c:choose>
