...
<script src="<c:url value='/js/env/money.js'/>"></script>
</head>
<body>
...
<div id="wrapper" class="wth100">
	...
	<div class="container">
		...
		<div class="contentWrap">
			<div class="content">
				<ol class="breadcrumb">
					<li class="active">공통정보 > 헌금분류</li>
				</ol>
				<div class="tableTypeHalf seachT">
					<table>
						<caption>헌금분류</caption>
						<colgroup>
			...
			<div class="layer layerDetail" id="div_drag_1">
				<div class="tit"><h4>헌금분류 상세</h4></div>
				<div class="layerCt">
					<div class="tableType2">
						<table>
							<caption>헌금분류 상세</caption>
							<colgroup>
							...
							<tbody>
								<tr><th>헌금코드</th>		<td id="dMoneyCode"></td>
									<th>헌금명</th>		<td id="dMoneyName"></td>
								</tr>
								<tr><th>계정</th>			<td id="dAcctCode"></td>
			...
			<%--<div class="tit"><h4>헌금분류 <span id="modetitle">추가</span></h4></div>--%>
				<div class="layerCt">
					<div class="tableType2">
						<table>
							<caption>헌금분류 등록</caption>
							<colgroup>
								<col style="width: 150px;" />
								<col style="width: *" />
								<col style="width: 150px;" />
							...
							<tbody>
								<tr><th><sup user-required="insert"><i class="fas fa-asterisk fa-xs text-danger"></i></sup>헌금코드</th>
									<td><input type="text" id="uMoneyCode" class="txtType" maxlength="40" required="required" user-required="insert"/></td>
									<th>헌금명</th>
									<td><input type="text" id="uMoneyName" class="txtType" maxlength="200"/></td>
								</tr>
								<tr><th>계정</th>
									<td><input type="text" id="uAcctCode" class="txtType" maxlength="200"/></td>
									<th>재정</th>
				...
				<div class="layerCt">
					<div class="tableType2">
						<table>
							...
							<tbody>
								<tr><th><sup user-required="insert"><i class="fas fa-asterisk fa-xs text-danger"></i></sup>헌금코드</th>
									<td><input type="text" id="iMoneyCode" class="txtType" maxlength="40" required="required" user-required="insert"/></td>
									<th>헌금명</th>
									<td><input type="text" id="iMoneyName" class="txtType" maxlength="200"/></td>
								</tr>
								<tr><th>계정</th>
									<td><input type="text" id="iAcctCode" class="txtType" maxlength="200"/></td>
									<th>재정</th>
