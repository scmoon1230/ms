...
<script src="<c:url value='/js/env/position.js'/>"></script>
</head>
<body>
...
<div id="wrapper" class="wth100">
	...
	<div class="container">
		...
		<div class="contentWrap">
			<div class="content">
				<ol class="breadcrumb">
					<li class="active">공통정보 > 직분코드</li>
				</ol>
				<div class="tableTypeHalf seachT">
					<table>
						<caption>직분코드</caption>
						<colgroup>
						...
						<tr>
							<th>직분명칭</th>
							<td><input type="text" name="" id="positionName" class="txtType searchEvt" style="ime-mode:active">
			...
			<div class="layer layerDetail" id="div_drag_1">
				<div class="tit"><h4>직분코드 상세</h4></div>
				<div class="layerCt">
					<div class="tableType2">
						<table>
							<caption>직분코드 상세</caption>
							<colgroup>
								<col style="width: 150px;" />
								<col style="width: *" />
							</colgroup>
							<tbody>
								<tr><th>직분코드</th>		<td id="dPositionCode"></td>
								</tr>
								<tr><th>직분명칭</th>		<td id="dPositionName"></td>
								</tr>
								<tr><th>정렬순서</th>		<td id="dSortOrder"></td>
								</tr>
							</tbody>
						</table>
					</div>
			...
			<%--<div class="tit"><h4>직분코드 <span id="modetitle">추가</span></h4></div>--%>
				<div class="layerCt">
					<div class="tableType2">
						<table>
							<caption>직분코드 등록</caption>
							<colgroup>
								<col style="width: 150px;" />
								<col style="width: *" />
							</colgroup>
							<tbody>
								<tr><th><sup user-required="insert"><i class="fas fa-asterisk fa-xs text-danger"></i></sup>직분코드</th>
								...
								<tr><th>정렬순서</th>
									<td><input type="text" id="uSortOrder" class="txtType" maxlength="200"/></td>
								</tr>
							</tbody>
						</table>
					</div>
					...
					<div class="tableType2">
						<table>
							...
							<tbody>
								...
								<tr><th>정렬순서</th>
									<td><input type="text" id="iSortOrder" class="txtType" maxlength="200"/></td>
								</tr>
							</tbody>
						</table>
					</div>
