	...
	<div class="container">
		...
		<div class="contentWrap">
			...
			<div class="content">
				...
				<form:form commandName="articleVO" action="${pageContext.request.contextPath}/egov/com/cop/bbs/insertArticle.do" method="post" onSubmit="fn_egov_regist_article(document.forms[0]); return false;" enctype="multipart/form-data"> 
				<div class="wTableFrm">
					<!-- 타이틀 -->
