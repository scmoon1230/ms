...
<script type="text/javascript">
	...
	function fn_egov_inqire_articlelist() {
		articleVO.action = "<c:url value='/egov/com/cop/bbs/selectArticleList.do'/>";
		articleVO.submit();
	}
</script>
</head>
	...
	<div class="container">
		...
		<div class="contentWrap">
			...
			<div class="content">
				...
				<!-- 상단타이틀 -->
				<form:form commandName="articleVO" action="${pageContext.request.contextPath}/egov/com/cop/bbs/updateArticle.do" method="post" onSubmit="fn_egov_updt_article(document.forms[0]); return false;" enctype="multipart/form-data">
					<div class="wTableFrm">
						...
						<c:if test="${boardMasterVO.fileAtchPosblAt == 'Y'}">
								...
								<tr>
									...
									<c:if test="${not empty articleVO.atchFileId}">
										<c:import charEncoding="UTF-8" url="/egov/com/cmm/fms/selectFileInfsForUpdate.do" >
						...
						<div class="btn">
							...
							<span class="btn_s"><a href="<c:url value='/egov/com/cop/bbs/selectArticleList.do' />?bbsId=${boardMasterVO.bbsId}&left=${articleVO.left}&top=${articleVO.top}&m=${articleVO.m}"  title="<spring:message code="button.list" /> <spring:message code="input.button" />"><spring:message code="button.list" /></a></span>
						</div>
					...
					<input type="hidden" name="top" value="${articleVO.top}">
					<input type="hidden" name="left" value="${articleVO.left}">
					<input type="hidden" name="child" value="${articleVO.child}">
