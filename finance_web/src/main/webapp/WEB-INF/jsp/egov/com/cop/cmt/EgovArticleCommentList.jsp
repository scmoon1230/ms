...
<%@ page import="kr.co.ucp.egov.com.cmm.service.EgovProperties" %>
...
<!-- 댓글 내용 -->
	...
	<form:form commandName="articleCommentVO" action="${pageContext.request.contextPath}/egov/com/cop/cmt/insertArticleComment.do" method="post" onSubmit="fn_egov_insert_commentList(); return false;" style="float:left; clear:both;">
		<div class="wTableFrm" >
			<table class="board_list top_line">
				<caption>${replyTitle } <spring:message code="title.create" /></caption>
				<colgroup>
		            <col style="width: 18vh;">
		            <col style="width: 160vh;">
				</colgroup>
				<tbody>
					<!-- 댓글 내용 -->
					<c:set var="title"><spring:message code="comCopCmt.articleCommentVO.commentCn"/> </c:set>
					<tr>
						<th style="padding:2%; text-align:center;">
							<label for="commentCn">${title } <span class="pilsu">*</span></label>
						</th>
						<td class="nopd">
