	...
	<div class="container">
		...
		<div class="contentWrap">
			...
			<div class="content">
				...
				<form:form commandName="articleVO" action="${pageContext.request.contextPath}/egov/com/cop/bbs/replyArticle.do" method="post" onSubmit="fn_egov_reply_article(document.forms[0]); return false;" enctype="multipart/form-data"> 
				<div class="wTableFrm">
					<!-- 타이틀 -->
					...
					<div class="btn">
						...
						<span class="btn_s"><a href="<c:url value='/egov/com/cop/bbs/selectArticleList.do' />?bbsId=${boardMasterVO.bbsId}"  title="<spring:message code="button.list" />  <spring:message code="input.button" />"><spring:message code="button.list" /></a></span>
