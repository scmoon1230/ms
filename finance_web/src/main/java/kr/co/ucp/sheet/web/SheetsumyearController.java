...
@Controller
public class SheetsumyearController {
	private final Logger logger = LoggerFactory.getLogger(this.getClass());

	@Resource(name="acctcodeService")
	AcctcodeService acctcodeService;

	@Resource(name="sheetsumyearService")
	SheetsumyearService sheetsumyearService;
	...
	// 리스트
	@RequestMapping(value="/sheet/sumyear.do")
	public String view(@ModelAttribute("loginVO") LoginVO loginVO, HttpServletRequest request, HttpServletResponse response, ModelMap model) throws Exception {
		...
		return "sheet/sheetsumyear";
	}

	// 조건검색
	@RequestMapping(value="/sheet/sumyear/list.json")
	@ResponseBody
	public Map<String, Object> list(ModelMap model, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		Map<String, String> durYear = sheetsumyearService.selectDurationYear(args);
		
		List<Map<String, String>> list = sheetsumyearService.selectSheetSumyear(args);

		Map<String, Object> map = new HashMap<String, Object>();
		map.put("rows", list);
		map.put("page", (String) request.getParameter("page"));
		map.put("duration", durYear.get("duration").toString());
	...
	@RequestMapping(value="/sheet/sumyear/getSum.json")
	@ResponseBody
	public Map<String, Object> getSum(ModelMap model, HttpServletRequest request, HttpServletResponse response) {

		Map<String, String> args = new HashMap<String, String>();
		args.put("stanYy"      , EgovStringUtil.nullConvert(request.getParameter("stanYy")));
		...
		try {
			List<Map<String, String>> list = sheetsumyearService.selectTotalAmnt(args);
