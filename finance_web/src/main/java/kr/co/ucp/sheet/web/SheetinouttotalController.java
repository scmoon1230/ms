...
@Controller
public class SheetinouttotalController {
	private final Logger logger = LoggerFactory.getLogger(this.getClass());

	@Resource(name="sheetinouttotalService")
	SheetinouttotalService sheetinouttotalService;
	...
	// 리스트
	@RequestMapping(value="/sheet/inouttotal.do")
	public String view(@ModelAttribute("loginVO") LoginVO loginVO, HttpServletRequest request, HttpServletResponse response, ModelMap model) throws Exception {
		...
		return "sheet/sheetinouttotal";
	}

	// 인쇄
	@RequestMapping(value="/sheet/inouttotalPrint.do")
	public String viewPrint(@ModelAttribute("loginVO") LoginVO loginVO, HttpServletRequest request, HttpServletResponse response, ModelMap model) throws Exception {
		...
		return "sheet/sheetinouttotalPrint";
	}

	// 조건검색
	@RequestMapping(value="/sheet/inouttotal/list.json")
	@ResponseBody
	public Map<String, Object> list(ModelMap model, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		List<Map<String, String>> list = sheetinouttotalService.selectSheetInouttotal(args);
