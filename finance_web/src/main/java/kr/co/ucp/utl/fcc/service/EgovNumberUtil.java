...
public class EgovNumberUtil {
	...
	try {
		...
		LOGGER.error("getRandomNum NullPointerException  : {}", e.getMessage());
		LOGGER.debug("{}", e);
	} catch (IllegalArgumentException e) {
		LOGGER.error("getRandomNum IllegalArgumentException  : {}", e.getMessage());
		LOGGER.debug("{}", e);
	} catch (Exception e) {
		LOGGER.error("getRandomNum Exception  : {}", e.getMessage());
		LOGGER.debug("{}", e);
	}
	...
	try {
		...
		LOGGER.error("getNumToStrCnvr NullPointerException  : {}", e.getMessage());
		LOGGER.debug("{}", e);
	} catch (Exception e) {
		LOGGER.error("getNumToStrCnvr Exception  : {}", e.getMessage());
		LOGGER.debug("{}", e);
	}
	...
	try {
		...
		LOGGER.error("getNumberValidCheck IndexOutOfBoundsException  : {}", e.getMessage());
		LOGGER.debug("{}", e);
	} catch (Exception e) {
		LOGGER.error("getNumberValidCheck Exception  : {}", e.getMessage());
		LOGGER.debug("{}", e);
	}
	...
	try {
		...
		LOGGER.error("getNumberCnvr IndexOutOfBoundsException  : {}", e.getMessage());
		LOGGER.debug("{}", e);
	} catch (Exception e) {
		LOGGER.error("getNumberCnvr Exception  : {}", e.getMessage());
		LOGGER.debug("{}", e);
	}
