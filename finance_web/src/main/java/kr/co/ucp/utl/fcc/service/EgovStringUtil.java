...
public class EgovStringUtil {
	...
	public static String isNullToStr(Object object, String param)
	{
		String string = "";
		if (object != null) {
			string = object.toString().trim();
	...
	// 파일명에 경로 문자 제거
	public static String filePathConvert(String strFileNm)
	{
		String fileNm = strFileNm;		
		if ( fileNm != null && !"".equals(fileNm) )
		{
			try{
				...
				LOGGER.error("filePathConvert NullPointerException  : {}",  ne.getMessage());
			} catch(Exception e){
				LOGGER.error("filePathConvert exception  : {}",  e.getMessage());
			}
	...
	try {
		...
		LOGGER.error("getRandomStr IllegalArgumentException  : {}", e.getMessage());
		LOGGER.debug("{}", e);
	} catch (Exception e) {
...
/**
	...
	try {
		...
		LOGGER.error("getSpclStrCnvr NullPointerException  : {}", e.getMessage());
		LOGGER.debug("{}", e);
	} catch (IndexOutOfBoundsException e) {
		LOGGER.error("getSpclStrCnvr IndexOutOfBoundsException  : {}", e.getMessage());
		LOGGER.debug("{}", e);
	} catch (Exception e) {
	...
	try {
		...
		LOGGER.error("getTimeStamp NullPointerException  : {}", e.getMessage());
		LOGGER.debug("{}", e);
	} catch (IllegalArgumentException e) {
		LOGGER.error("getTimeStamp IllegalArgumentException  : {}", e.getMessage());
		LOGGER.debug("{}", e);
	} catch (Exception e) {
    ...
    public static String getHtmlStrCnvr(String srcString) {
		...
		try
		{
			...
			LOGGER.error("getHtmlStrCnvr PatternSyntaxException  : {}", e.getMessage());
			LOGGER.debug("{}", e);
		}
		catch (Exception ex)
		{
	...
	// 00 ~ 23 시간 LIST
	public static List<Map<String, String>> timeHour()
	{
	...
	// 00 ~ 59 분 LIST
	public static List<Map<String, String>> timeMinute()
	{
		List<Map<String, String>> list = new ArrayList<Map<String, String>>();
		String str = "";
		for (int i=0; i<7; i++)
		{
			...
			if ( i == 6 ) {
				...
				str = i + "0";	//str = String.valueOf(i) + "0";
			}
			map.put("CD_ID", str);
			map.put("CD_NM_KO", str);
			list.add(map);
