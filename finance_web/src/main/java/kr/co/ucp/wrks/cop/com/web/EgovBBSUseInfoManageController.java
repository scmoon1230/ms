...
import kr.co.ucp.wrks.cop.com.service.BoardUseInf;
import kr.co.ucp.wrks.cop.com.service.BoardUseInfVO;
import kr.co.ucp.wrks.cop.com.service.EgovBBSUseInfoManageService;
...
public class EgovBBSUseInfoManageController {
  ...
  //SHT-CUSTOMIZING//}
     ...
     * @throws Exception
     */
    @RequestMapping(value="/wrks/cop/com/deleteBBSUseInf.do")
    public String deleteBBSUseInf(@ModelAttribute("searchVO") BoardUseInfVO bdUseVO, @ModelAttribute("bdUseInf") BoardUseInf bdUseInf, SessionStatus status, ModelMap model) throws Exception
    {
		...
		return "forward:/wrks/cop/com/selectBBSUseInfs.do";
    }
     ...
     * @throws Exception
     */
    @RequestMapping(value="/wrks/cop/com/addBBSUseInf.do")
     ...
     * @throws Exception
     */
    @RequestMapping(value="/wrks/cop/com/insertBBSUseInf.do")
    public String insertBBSUseInf(@ModelAttribute("searchVO") BoardUseInfVO bdUseVO, @ModelAttribute("boardUseInf") BoardUseInf boardUseInf, BindingResult bindingResult, @RequestParam Map<String, Object> commandMap, ModelMap model) throws Exception
    {
		...
		boardUseInf.setFrstRegisterId(user.getUserId());
     ...
     * @throws Exception
     */
    @RequestMapping(value="/wrks/cop/com/selectBBSUseInfs.do")
     ...
     * @throws Exception
     */
    @RequestMapping(value="/wrks/cop/com/updateBBSUseInf.do")
    public String updateBBSUseInf(@ModelAttribute("searchVO") BoardUseInfVO bdUseVO, @ModelAttribute("boardUseInf") BoardUseInf boardUseInf, HttpServletRequest request, ModelMap model) throws Exception
    {
     ...
     * @throws Exception
     */
    @RequestMapping(value="/wrks/cop/com/selectBBSUseInf.do")
    public String selectBBSUseInf(@ModelAttribute("searchVO") BoardUseInfVO bdUseVO, ModelMap model) throws Exception
    {
		...
		if ("SYSTEM_DEFAULT_BOARD".equals(vo.getTrgetId())) {
			...
			vo.setProvdUrl("/wrks/cop/bbs/anonymous/selectBoardList.do?bbsId=" + vo.getBbsId());
		    } else {
			vo.setProvdUrl("/wrks/cop/bbs/selectBoardList.do?bbsId=" + vo.getBbsId());
		    }
		}
     ...
     * @throws Exception
     */
    @RequestMapping(value="/wrks/cop/com/selectBBSUseInfsByTrget.do")
     ...
     * @throws Exception
     */
    @RequestMapping(value="/wrks/cop/com/updateBBSUseInfByTrget.do")
    		...
    		@RequestParam Map<String, Object> commandMap, SessionStatus status, ModelMap model) throws Exception
    {
		...
		return "forward:/wrks/cop/com/selectBBSUseInfsByTrget.do";
    }
     ...
     * @throws Exception
     */
    @RequestMapping(value="/wrks/cop/com/insertBBSUseInfByTrget.do")
