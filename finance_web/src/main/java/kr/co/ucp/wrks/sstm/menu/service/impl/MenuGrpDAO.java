...
public class MenuGrpDAO extends EgovAbstractMapper{
	...
	public List<Map<String, String>> getCM_DSTRT_CD_MNG(Map<String, String> map) throws Exception{
		return selectList("wrks_sstm_menu_grp.list_cm_dstrt_cd_mng", map);
	}
     ...
     */
	@SuppressWarnings("unchecked")
	public List<Map<String, String>> list_grp(Map<String, String> args) throws Exception{
		return selectList("wrks_sstm_menu_grp.list_grp", args);
	}
	...
	public List<Map<String, String>> list(Map<String, String> args) throws Exception{
		return selectList("wrks_sstm_menu_grp.list", args);
	}
	...
	public int update(List<Map<String, String>> args) throws Exception{
    	for(int i = 0; i < args.size(); i++) {
    		...
    		Map<String, String> resultMap =  (Map<String, String>) selectOne("wrks_sstm_menu_grp.get_grpId", arg);

    		if(arg.get("RGS_AUTH_YN").equals("N") && arg.get("SEA_AUTH_YN").equals("N") && arg.get("UPD_AUTH_YN").equals("N") && arg.get("DEL_AUTH_YN").equals("N")) {
        		if(resultMap != null)
            		delete("wrks_sstm_menu_grp.delete", arg);
    		}
    		else {
        		if(resultMap == null)
            		insert("wrks_sstm_menu_grp.insert", arg);
        		else {
            		if(!(
            			...
            			update("wrks_sstm_menu_grp.update", arg);
            		}
        		}
    		}
    	}
	...
	public int copy(Map<String, String> args) throws Exception{
		delete("wrks_sstm_menu_grp.copy", args);
		return 1;
	}
}
