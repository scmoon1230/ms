 ...
 * ----------------------------------------------------------------------------------
 *
 * @File Name    : TvoOutDetailController.java
...
@Controller
public class TvoOutListController {
    ...
    @Resource(name = "tvoOutListService")
    private TvoOutListService tvoOutListService;

    // CCTV접속목록
    @RequestMapping(value = "/wrks/evtctl/stats/tvoOutList.do")
    public String tvoOutList(HttpServletRequest request, HttpServletResponse response, ModelMap model) throws Exception {
        ...
        /* row per page 설정 끝 */
        return "/wrks/evtctl/stats/tvoOutList";
    }

    @RequestMapping(value = "/wrks/evtctl/stats/tvoOutList.json")
    @ResponseBody
    public Map<String, Object> tvoOutListData(ModelMap model, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        List<Map<String, String>> resultRows = tvoOutListService.tvoOutList(args);
    ...
    @RequestMapping(value = "/wrks/evtctl/stats/tvoOutListExcel.excel")
    public String tvoOutListExcel(ModelMap model, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        List<Map<String, String>> resultRows = tvoOutListService.tvoOutListExcel(args);

		String titleKey = "outRqstYmdhms|outRqstUserNm|evtNo|evtNm|rqstRsnTyNm|paperNo|cctvNm|vdoYmdhmsFrTo|playEndYmdhms|tvoPrgrsNm|maskingYn";
		String titleHeader = "신청일시|신청자|사건번호|사건명|신청사유|공문/전자문서|CCTV명|영상요청구간|재생종료일시|진행상태|마스킹여부";
        // 제목 및 검색조건 추가
        String tit = "반출신청현황";
		model.put("title", tit);
