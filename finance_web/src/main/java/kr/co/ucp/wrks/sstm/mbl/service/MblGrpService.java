 ...
 * ----------------------------------------------------------
 * */
public interface MblGrpService {

	List<Map<String, String>> getList(Map<String, String> args) throws Exception;

	@SuppressWarnings("rawtypes")
	List grpList(Map<String, Object> map) throws Exception;

	@SuppressWarnings("rawtypes")
	List moblNoList(Map<String, Object> map) throws Exception;
