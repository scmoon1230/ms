...
@Controller
public class FinchangeController {
	private final Logger logger = LoggerFactory.getLogger(this.getClass());

	@Resource(name="finchangeService")
	FinchangeService finchangeService;
	...
	// 리스트
	@RequestMapping(value="/fin/change.do")
	public String view(@ModelAttribute("loginVO") LoginVO loginVO, HttpServletRequest request, HttpServletResponse response, ModelMap model) throws Exception {
		...
		return "fin/finchange";
	}

	// 조건검색
	@RequestMapping(value="/fin/change/list.json")
	@ResponseBody
	public Map<String, Object> selectFinchange(ModelMap model, HttpServletRequest request, HttpServletResponse response) throws Exception {
	...
	//	args.put("inoutGb", (String) request.getParameter("inoutGb"));
		...
		List<Map<String, String>> list = finchangeService.selectFinchange(args);
