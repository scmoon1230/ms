...
@Controller
public class FinweekController {
	private final Logger logger = LoggerFactory.getLogger(this.getClass());

	@Resource(name="finweekService")
	FinweekService finweekService;
	...
	// 리스트
	@RequestMapping(value="/fin/week.do")
	...
	// 조건검색
	@RequestMapping(value="/fin/week/list.json")
	@ResponseBody
	public Map<String, Object> list(ModelMap model, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		List<Map<String, String>> list = finweekService.selectFinweek(args);
