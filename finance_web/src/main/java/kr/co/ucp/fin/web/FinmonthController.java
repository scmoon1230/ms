...
public class FinmonthController {
	...
	@Resource(name="finmonthService")
	FinmonthService finmonthService;
	...
	// 리스트
	@RequestMapping(value="/fin/month.do")
	...
	// 조건검색
	@RequestMapping(value="/fin/month/list.json")
	@ResponseBody
	public Map<String, Object> list(ModelMap model, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		List<Map<String, String>> list = finmonthService.selectFinmonth(args);
