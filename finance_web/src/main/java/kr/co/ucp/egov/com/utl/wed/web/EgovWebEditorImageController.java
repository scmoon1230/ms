package kr.co.ucp.egov.com.utl.wed.web;
...
import kr.co.ucp.egov.com.cmm.service.EgovProperties;
import kr.co.ucp.egov.com.utl.fcc.service.EgovFileUploadUtil;
import kr.co.ucp.egov.com.utl.fcc.service.EgovFormBasedFileUtil;
import kr.co.ucp.egov.com.utl.fcc.service.EgovFormBasedFileVo;
...
public class EgovWebEditorImageController {
    ...
    /** 첨부파일 위치 지정 */
    //private final String uploadDir = EgovProperties.getProperty("Globals.dirWrksHome") + EgovProperties.getProperty("Globals.dirBbs");
    //private final String uploadDir = prprtsService.getString("DIR_WRKS_HOME") + prprtsService.getString("DIR_BBS_FILE");
	...
	String uploadDir = prprtsService.getString("DIR_WRKS_HOME") + prprtsService.getString("DIR_BBS_FILE");
